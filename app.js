...
$(document).ready(function () {
  var $card = $(".card"),
    ...
    let textTitle = "Gửi pé!";
    let charArrTitle = textTitle.split('');
let text = "Chúc mừng Giáng Sinh! Mùa lễ này, hãy bên nhau chia sẻ niềm vui và tình thương. Chúng ta có thể tận hưởng những khoảnh khắc ấm áp và ý nghĩa bên gia đình và bạn bè. Hy vọng rằng mỗi chiếc đèn trang trí và hương thơm của cây thông sẽ mang lại không khí lễ hội, làm cho mỗi khoảnh khắc trở nên đặc biệt.Ký tên: Ông già Noel(Nguyễn Tuấn Kiệt)"
